	...
	<div id="rightContent">
				...
				<div class="container-fluid">
					<form class="form-horizontal"
						action="<%=request.getContextPath()%>/goodsHandler/goods" method="Post" enctype="multipart/form-data">
						<input type="hidden" name="_method" value="PUT">
						<div class="form-group ">
							<label for="sName" class="col-xs-3 control-label"></label>
							<div class="col-xs-8 ">
								<img src='<%=request.getContextPath()%>/goodsHandler/getImage?materialUrl=${goods.id}' >
						...
						<div class="form-group">
							...
							<div class="col-xs-8 ">
								<input type="text" class="form-control input-sm duiqi" required="required"
						...
						<div class="form-group">
							...
							<div class="col-xs-8 ">
								 <input required="required" name="goodsy"  type="radio" value="红色" checked="${goods.goodsColor }" /><fmt:message key="red"></fmt:message>
								 <input	required="required" name="goodsy" type="radio" value="黑色" checked="${goods.goodsColor }"  /><fmt:message key="black"></fmt:message>S
							</div>
							...
							<input type="hidden" class="form-control input-sm duiqi"
							name="code" id="code" placeholder="" value="${goods.code}">
