	...
	<div id="rightContent">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">修改代理</h4>
			</div>
			<div class="panel-body" style="padding-left: 20%;">
				<div class="container-fluid">
					<form class="form-horizontal" action="<%=request.getContextPath() %>/brand/update" method="post" enctype="multipart/form-data">
						<div class="form-group ">
							<label for="sName" class="col-xs-3 control-label"><fmt:message key="brand.name"></fmt:message></label>
							<div class="col-xs-8 ">
								<input type="hidden" name="braid" value="${brand.id }">
								 <input type="text" class="form-control input-sm duiqi" id="brName"  name="brand_name" value="${brand.brand_name }">
						...
						<div class="form-group ">
							...
							<div class="col-xs-8 ">
								<input type="text" class="form-control input-sm duiqi" id="brTel" name="brand_tel" value="${brand.brand_tel }">
							</div>
						</div>
						<div class="form-group">
							<label for="sOrd" class="col-xs-3 control-label"><fmt:message key="brand.path"></fmt:message></label>
							<div class="col-xs-8">
								<input type="file" id="brurl" placeholder="" name="brurl" >
							</div>
						</div>
