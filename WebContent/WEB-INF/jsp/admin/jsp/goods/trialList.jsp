		...
		success:function(obj){
			...
			for(var i=0;i<obj.list.length;i++){
				...
				$("#trialquery").append(
						...
						"<td>"+
							"<a href='<%=request.getContextPath()%>/GoodsTrial?id="+obj.list[i].id+"'><button class='btn btn-success btn-xs' data-toggle='modal' id='tg'><fmt:message key="PassTheAudit"></fmt:message></button></a>"+
							"<a href='' name='deleteid' id='"+obj.list[i].id+"'><button class='btn btn-danger btn-xs' data-toggle='modal'><fmt:message key="FailureToPassAudit"></fmt:message></button></a>"+ 
						"</td>"+
					"</tr>"
				);
			}
                ...
                <div class="data-div">
                    <div class="row tableHeader">
                        <div class="col-xs-1 " style="margin-left: 40px">
        					<fmt:message key="Code"></fmt:message>               
                        </div>
                         <div class="col-xs-1" style="margin-left: 120px">
                          	<fmt:message key="MerchandisePictures"></fmt:message>
                        </div>
                        <div class="col-xs-1" style="margin-left: 130px">
                          	<fmt:message key="NameOfCommodity"></fmt:message>
                        </div>
                        
                        <div class="col-xs-1" style="margin-left: 60px">
                            	<fmt:message key="commodityPrice"></fmt:message>
                        </div>

                        <div class="col-xs-1"style="margin-left: 30px">
                            	<fmt:message key="CommodityDescription"></fmt:message>
                        </div>
                        <div class="col-xs-1" style="margin-left: 20px">
                            	<fmt:message key="CommodityColour"></fmt:message>
                        </div>
                        <div class="col-xs-1" style="margin-left: 40px">
                            	<fmt:message key="toExamine"></fmt:message>
                        </div>
                        
                          </div>
                        <div class="tablebody">
							<div class="sitTable">
								<table class="row table table-responsive" id="trialquery">
									<!-- 数据 -->
								</table>
							</div>
						</div>
